		...
		>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-20">
				...
				<Card
					...
					des="I develop sleek, high-performance user interfaces using React, leveraging Tailwind CSS, CSS3, and Bootstrap to ensure responsiveness, scalability, and a seamless user experience."
					icon={<AiFillAppstore />}
				/>
				<Card
